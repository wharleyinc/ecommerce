...
let EcommerceComponent = class EcommerceComponent {
    constructor(ecommerceService, stepperService) {
...
class Product {
    constructor(id, name, price, pictureUrl, category) {
        this.id = id;
        this.name = name;
        this.price = price;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ngx_stripe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-stripe */ "./node_modules/ngx-stripe/fesm2015/ngx-stripe.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
let PaymentComponent = class PaymentComponent {
    constructor(fb, stripeService, stepperService, ecommerceService) {
        this.fb = fb;
...
let ProductsComponent = class ProductsComponent {
    ...
    loadProducts() {
        this.ecommerceService.getAllProducts().subscribe((products) => {
            this.products = products;
            this.products.forEach(product => {
                this.productOrders.push(new _models_product_order_model__WEBPACK_IMPORTED_MODULE_2__["ProductOrder"](product, 0, 'N/A'));
            });
        }, (error) => {
            console.log(error);
        });
...
let ShoppingCartComponent = class ShoppingCartComponent {
    ...
    loadCart() {
        this.sub = this.ecommerceService.ProductOrderChanged.subscribe(() => {
            ...
            if (productOrder) {
                this.orders.productOrders.push(new _models_product_order_model__WEBPACK_IMPORTED_MODULE_4__["ProductOrder"](productOrder.product, productOrder.quantity, productOrder.size));
            }
...
let StepperComponent = class StepperComponent {
    constructor(stepperService, ecommerceService) {
        this.stepperService = stepperService;
        this.ecommerceService = ecommerceService;
    }
    ngOnInit() {
